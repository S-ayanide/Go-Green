...
import 'package:go_green/menu/menu_item.dart';
                    ...
                    children: <Widget>[
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context)
                              .add(NavigationEvents.ClimateClickedEvent);
                        },
                      ),
                      Divider(
                        height: 64,
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context)
                              .add(NavigationEvents.HackDeatilsClickedEvent);
                        },
                      ),
                    ],
                  ),
